...
В папке нужного модуля есть каталог **src** - пример + оттуда подключать js,css
В папке нужного модуля есть каталог **example** - пример, как подключить в свой проект и как использовать JS
